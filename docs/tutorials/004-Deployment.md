...
**Note:**
you have to choose the 'AppName' that is configured for your App Build in your 'package.json' e.g. if just pull the 'TCSTK-Case-Manager-App' from GitHub the 'AppName' is "TCSTKTEMPLATE"
...
For this TCSTKTEMPLATE App two Groups can be configured for the following Roles
